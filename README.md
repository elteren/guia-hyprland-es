...
- **Excepción Affinity**: el AppImage de Affinity (`affinity.exe`, empaqueta Wine) se abre **tileado** como app normal (borde estándar); solo su ventana principal. Sus menús de contexto (título vacío) siguen flotando junto al cursor.
